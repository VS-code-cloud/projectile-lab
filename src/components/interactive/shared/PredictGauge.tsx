...
/**
 * A vertical drag-to-predict gauge shared by question steps. The learner drags
 * the thumb to estimate a quantity and locks it in; the gauge then reveals the
 * true value beside their guess. The chosen value is the graded answer, so this
 * turns every question into an active "predict, then check" moment.
 *
